...
public class UserHave_Dao {
	...
	public void login(UserHave uh2) {
		...
		db.preUpdate(sql, uh2.getUserNo().getName(), uh2.getUserNo().getPhone(), uh2.getUserNo().getPassword(),
				uh2.getUserNo().getAdress(), uh2.getUserNo().getMoney(), uh2.getPetName(), uh2.getPetAge(),
